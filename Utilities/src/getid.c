...
static const char rcsid[] = "$Id: getid.c,v 1.31.4.1 1998/03/19 14:22:18 partain Exp $";
...
getid.c
     ...
     string or a clustername for a group of SNMP parties and contexts
	...
	./getid -v2 [-ctx contextName] localhost Guest           (SNMPv2 clustername)
*/
...
//                  char *argv[]));
extern int EntryPoint_GetId (int argc, char *argv[]);

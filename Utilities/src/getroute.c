...
static const char rcsid[] = "$Id: getroute.c,v 1.32.4.1 1998/03/19 14:22:21 partain Exp $";
...
getroute.c
     ...
     munity string to provide access to that entity or a clustername
     for a group of SNMP parties and contexts (cluster).
     ...
     Example:
        ...
        ./getroute -v2 myagent Guest         (SNMPv2 clustername)
*/
...
extern int EntryPoint_GetRoute (int argc, char *argv[]);

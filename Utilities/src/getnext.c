...
static const char rcsid[] = "$Id: getnext.c,v 1.31.4.1 1998/03/19 14:22:20 partain Exp $";
...
getnext.c
     ...
     munity string for access to the SNMP entity or a clustername for
     a group of SNMP parties and contexts (cluster), and the variable name(s)
     ...
     getnext -v[1|2c] suzzy topSecret system interfaces    (community string)
                       or
     getnext -v2 suzzy Guest system interfaces     (SNMPv2 clustername)
...
extern int EntryPoint_GetNext (int argc, char *argv[]);

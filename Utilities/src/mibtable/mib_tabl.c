...
*	@item		10-Jan-2002		Artur Perwenis		Commented out 'unassigned_text' assignment as it is externally linked from elsewhere.
*/
/*
 *
...
static const char rcsid[] = "$Id: mib_tabl.c,v 1.12 1998/01/06 18:53:17 mark Exp $";
...
//#undef DO_NOT_DECLARE_MIB_OID_TABLE

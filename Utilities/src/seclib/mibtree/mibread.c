...
static const char rcsid[] = "$Id: mibread.c,v 1.16 1998/01/06 18:54:00 mark Exp $";
    ...
    const char *filename;
{
	...
	//Shouldn't we pass default_mib_tree instead of NULL?
...
#ifndef HAVE_EIGHT_BYTE_LONGS
#define U_RANGE_FORMAT "%lu..%lu)"
#define RANGE_FORMAT "%ld..%ld)"
#else   /* HAVE_EIGHT_BYTE_LONGS */
#define U_RANGE_FORMAT "%u..%u)"
#define RANGE_FORMAT "%d..%d)"

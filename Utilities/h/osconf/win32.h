...
/* $Id: win32.h,v 1.23 1998/01/09 20:56:56 spakes Exp $ */
...
/* windows doesn't have pid_t, which we use in a few places */
typedef int pid_t;
...
/* Define NEWTIME for unix/win32 combos */
#ifndef NEWTIME
#define NEWTIME 1
#endif /* NEWTIME */

/* Define SR_WINSOCK for unix/win32 combos */
#ifndef SR_WINSOCK
#define SR_WINSOCK 1
#endif /* SR_WINSOCK */

/* Define SR_WINDOWS_CONSOLE for unix/win32 combos */
#ifndef SR_WINDOWS_CONSOLE
#define SR_WINDOWS_CONSOLE 1

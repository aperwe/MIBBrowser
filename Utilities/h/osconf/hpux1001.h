...
/* $Id: hpux1001.h,v 1.20 1998/01/09 20:56:17 spakes Exp $ */

#ifndef SR_HPUX1001_H
#define SR_HPUX1001_H
...
/* manually added */
/* HPUX select prototype takes int* */
#define SELECT_BITMASK_TYPE int *

/* HPUX uses BIND_* rather than RTLD_* */
...
/*
 * On HP-UX, if using the ANSI compilation (-Aa), you get a limited set
 * of the full capabilities.  To get all of these capabilities (such as
* the definition of size_t, define _HPUX_SOURCE
 */
#ifdef __STDC__
#define _HPUX_SOURCE
#endif  /* __STDC__ */
 ...
 * On HP/UX 10.x, if you don't pass -Aa to the C compiler,
 * const will not work.
 */

...
/*
 * Note that this file is for AIX 4.  AIX 3 does not have some of the
 * include files that AIX 4 does.
 */

/* $Id: aix.h,v 1.19 1998/01/09 20:55:59 spakes Exp $ */
...
/* This was added on the assumption that if netinet/ip.h
   exists, netinet/tcp.h should, too.  */
...
#define HAVE_NETNS_IDP_H 1

/* Define if you have the <netns/ns.h> header file.  */
#define HAVE_NETNS_NS_H 1
